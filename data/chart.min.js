...
!function(t, e) {
        ...
        buildOrUpdateScales()
        {
            ...
            J(s, (i => {
                const s = i.options,
                    ...
                    r = Ln(a, s),
                    l = K(s.type, i.dtype);
                void 0 !== s.position && jn(s.position, r) === jn(i.dposition) || (s.position = i.dposition),
                o[a] = !0;
                let c = null;
    ...
    function Ko(t) {
        return (t.scale || {}).getPointPositionForValue ? function(t) {
            ...
            if (h = "start" === i ? a : "end" === i ? r : U(i) ? i.value : e.getBaseValue(), n.grid.circular)
                return c = e.getPointPositionForValue(0, a), new qo({
                    x: c.x,
                    y: c.y,
    ...
    function ls(t, e, i) {
        ...
        n && o.points.length && (Gt(t, i), function(t, e) {
            ...
            t.save(),
            "x" === l && s !== o && (is(t, n, a.top), rs(t, {
                line: i,
                target: n,
                color: o,
                scale: r,
                property: l
            }), t.restore(), t.save(), is(t, n, a.bottom)),
            rs(t, {
                line: i,
                target: n,
                color: s,
    ...
    class Ns extends Ts {
        ...
        drawBackground()
        {
            ...
            if (e) {
                ...
                n.save(),
                n.beginPath(),
                Bs(t, t.getDistanceFromCenterForValue(t._endValue), i, t.getLabels().length),
                n.closePath(),
                n.fillStyle = e,
                n.fill(),
                n.restore()
